...
export default function AboutPanel({ onClose }: AboutPanelProps) {
    ...
    return (
        ...
        >
            <div className="flex flex-1 flex-col px-4 pt-4 sm:px-8 sm:pt-12 text-white min-h-0 overflow-y-auto">
                ...
                <div className="flex-1 pt-8 pb-14">
                    <div className="flex flex-col items-center mx-auto bg-black/25 border border-white/10 backdrop-blur-md shadow-2xl px-6 sm:px-8 py-10 rounded-4xl w-full max-w-lg">
