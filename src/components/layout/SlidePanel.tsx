    ...
    return (
        ...
        >
            <div
                ...
                className="absolute inset-y-0 left-1.5 w-2 z-10 touch-none flex items-center justify-center cursor-grab active:cursor-grabbing"
            >
                <div className="w-1 h-16 rounded-full bg-white/15" />
            </div>
            {children}
        </motion.div>
    );
